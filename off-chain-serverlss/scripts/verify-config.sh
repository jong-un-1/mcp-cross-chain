...
# ==================================================
# Cross-Chain DEX Microservices - Configuration Verification Script  
# ==================================================

echo "🔍 Verifying Cross-Chain DEX Microservices Configuration..."
echo
...
# Check microservices database configuration  
echo
echo "🗄️ Checking microservices database configuration..."
DB_ID=$(grep "database_id.*cross-chain-dex-db" wrangler.toml)
if [ ! -z "$DB_ID" ]; then
    echo "✅ Microservices database configured: cross-chain-dex-db"
else
    echo "❌ Microservices database ID not found"
fi
