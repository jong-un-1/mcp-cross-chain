...
function programCommand(name: string) {
  return program
    ...
    .option(
      ...
      join(homedir(), ".config/solana/genius-temp-admin.json") // Expand the home directory
    )
    .option(
      // mainnet-beta, testnet, devnet
      "-r, --rpc <string>",
